A simple forum application built with Go and SQLite. Users can create accounts, log in, and post topics. The forum is only accessible on your local machine.
